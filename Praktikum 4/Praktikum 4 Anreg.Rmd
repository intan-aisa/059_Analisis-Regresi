...
```{r}
library(readxl)
dt <- read_xlsx("/Users/intanaisa/Documents/Kuliah/Semester 4/Analisis Regresi/Dataset Anreg.xlsx", sheet="P4")
dt
```
...
x1 <- dt$"Jumlah Tenaga Kerja"
x2 <- dt$"Jumlah Objek Wisata"
...
Didapatkan persamaan regresi yaitu $y = 2,014,401 + 10,433.44x_1 -116,823.8x_2$
