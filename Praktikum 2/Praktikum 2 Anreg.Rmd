...
data <- read_excel("/Users/intanaisa/Downloads/NSC-2025.xlsx", sheet="Sheet2")
...
dengan Y adalah persentase penduduk miskin dan X8 Tingkat Partisipasi Angkatan Kerja (TPAK).

Didapatkan nilai $\hat\beta_0 = 109.11880$ artinya nilai dugaan rataan indeks pembangunan manusia ketika tingkat partisipasi angkatan kerja bernilai 0 persen adalah 109.11880, akan tetapi nilai 0 tidak ada dalam selang pengamatan tingkat partisipasi angkatan kerja sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_0 = -0.46621$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika tingkat partisipasi angkatan kerja satu persen adalah sebesar -0.46621%

Koefisien determinasi yang dihasilkan adalah 0.1887 atau 18.87% artinya keragaman Indeks Pembangunan Manusia yang dapat dijelaskan oleh persentase tingkat partisipasi angkatan kerja adalah sebesar 18.87%, sisanya yaitu 81.13% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
